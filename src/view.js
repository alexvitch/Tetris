export default class View {
    ...
    constructor(element, width, height, rows, columns) {
        ...
        this.playfieledX = this.playfieldBorderWidth;
        this.playfieledY = this.playfieldBorderWidth;
    ...
    renderPlayfield ({ playfield }) {
        for (let y = 0; y < playfield.length; y++) {   
            ...
            for (let x = 0; x < line.length; x++) {
                ...
                if (block) { 
                   this.renderBlock(
                       this.playfieledX + (x * this.blockWidth),
                       this.playfieledY + (y * this.blockHeight),
                       this.blockWidth,
                       this.blockHeight,
                       View.colors[block]
                       );
